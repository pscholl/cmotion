...
public class DirectoryChooserDialog {
    ...
    private AlertDialog.Builder createDirectoryChooserDialog(String title, List<String> listItems,
        ...
        LinearLayout titleLayout = (LinearLayout) inflater.inflate(R.layout.dialog_choosedir, null);

        m_titleView = (TextView) titleLayout.findViewById(R.id.titleTextView);
        m_titleView.setText(title);

        Button newDirButton = (Button) titleLayout.findViewById(R.id.newDirButton);
